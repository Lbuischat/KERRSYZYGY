...
export class Login
   ...
   * Large orbit.
   *
   * These values correspond to the SVG ellipse:
   *
   * cx = 450
   * cy = 250
   * rx = 360
   ...
   * Deliberately slow.
   *
   * The planetary system should feel alive,
   * not animated.
   */
  ...
  constructor() {
    ...
    afterNextRender(() => {
      ...
      /*
       * Let the visual entrance happen
       * before starting the continuous motion.
       */
  ...
  ngAfterViewInit(): void {
    ...
    /*
     * Google Identity Services is loaded
     * externally, so wait for it to exist.
     */
        ...
        (response: any) => {
          ...
          .subscribe({
            ...
            next: (user) => {
              ...
              console.log(
                '✅ BACKEND VERIFIED GOOGLE USER:',
                user
              );

              /*
               * Login is successfully verified.
               *
               * Navigation can be added here when
  ...
  private createBackgroundStars(): void {
    ...
    for (
      ...
      this.backgroundStars.push({
        ...
        /*
         * Login begins with the stars,
         * so their delays are much earlier
         * than on the title screen.
         */
  ...
  private startAnimation(): void {
    ...
    /*
     * Start the planet at the right side
     * of the ellipse.
     */
