import { $n as Output, Bt as computed, Dc as Injector, Dl as ɵɵdefineInjector, Dn as Host, Do as ɵɵgetInheritedFactory, Ec as InjectionToken, En as ElementRef, In as Input, Jo as ɵɵlistener, Ll as require_cjs, Mr as afterNextRender, O as booleanAttribute, Pn as Inject, Qn as Optional, Uc as RuntimeError, Ui as setClassMetadata, ao as ɵɵdirectiveInject, ba as ɵɵclassProp, bc as EventEmitter, ca as ɵɵNgOnChangesFeature, cc as require_operators, dr as Service, hc as DestroyRef, ia as ɵɵControlFeature, io as ɵɵdefineService, ir as Renderer2, la as ɵɵProvidersFeature, nl as formatRuntimeError, no as ɵɵdefineNgModule, pr as SkipSelf, qc as Version, qn as NgModule, qt as untracked, r as ChangeDetectorRef, rl as forwardRef, sa as ɵɵInheritDefinitionFeature, sl as inject, tl as effect, tn as ApplicationRef, to as ɵɵdefineDirective, ur as Self, va as ɵɵattribute, vi as isPromise, wn as Directive, xl as signal, yi as isSubscribable } from "./core-DI804xF1.js";
import { s as getDOM } from "./_xhr-chunk-x_ich5Fj.js";
...
function toObservable(value) {
	const obs = isPromise(value) ? (0, import_cjs.from)(value) : value;
...
function composeAsync(validators) {
	...
	if (presentValidators.length == 0) return null;
	return function(control) {
		return (0, import_cjs.forkJoin)(executeValidators(control, presentValidators).map(toObservable)).pipe((0, import_operators.map)(mergeErrors));
	};
}
...
var NgControl = class extends AbstractControlDirective {
	...
	setupCustomControl() {
		...
		this.subscription = new import_cjs.Subscription();
